 ...
 const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     [1] = LAYOUT_65_ansi_blocker_split_bs(
         ...
         _______, KC_LEFT, KC_DOWN, KC_RIGHT,_______, _______, _______, KC_NUM , KC_SCRL, KC_HOME, KC_PGUP, KC_PSCR, _______,                   KC_HOME,
         _______, _______, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, KC_END,  KC_PGDN, _______,                   KC_VOLU, KC_END,
